...
- Manifest: `/blue/hmedeiros/qinruoyao/agvlm/data/manifests/full/sft_train_phi4_max3_balanced_v2_instructional.jsonl`
...
### classification.2 `ip102-ip102-v1-1-images-30610-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/30610.jpg`
...
```text
Answer: 45 alfalfa weevil
```

### classification.3 `ip102-ip102-v1-1-images-73998-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/73998.jpg`
...
```text
Answer: 102 Cicadellidae
```

### classification.4 `ip102-ip102-v1-1-images-43336-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/43336.jpg`
...
```text
Answer: 64 Polyphagotars onemus latus
```

### classification.5 `plantvillage-train-001156`
...
### classification.6 `ip102-ip102-v1-1-images-43726-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/43726.jpg`
...
```text
Answer: 66 parathrene regalis
```

### classification.7 `ip102-ip102-v1-1-images-50175-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/50175.jpg`
...
```text
Answer: 69 Xylotrechus
```

### classification.8 `plantvillage-train-043301`
...
### classification.9 `ip102-ip102-v1-1-images-67147-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/67147.jpg`
...
```text
Answer: 95 Lawana imitata Melichar
```

### classification.10 `plantvillage-train-037682`
...
### classification.11 `ip102-ip102-v1-1-images-02978-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/02978.jpg`
...
```text
Answer: 5 yellow rice borer
```

### classification.12 `plantvillage-train-003292`
...
### classification.13 `ip102-ip102-v1-1-images-12574-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/12574.jpg`
...
```text
Answer: 19 black cutworm
```

### classification.14 `plantvillage-train-010240`
...
### classification.15 `plantvillage-train-013953`
...
### classification.16 `plantvillage-train-009680`
...
### classification.17 `plantvillage-train-007038`
...
### classification.18 `ip102-ip102-v1-1-images-67441-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/67441.jpg`
...
```text
Answer: 96 Salurnis marginella Guerr
```

### classification.19 `ip102-ip102-v1-1-images-27539-jpg`

- Source: `ip102`
- Verifier: `label`
- Images: `data/raw/ip102/full/ip102_v1.1/images/27539.jpg`
...
```text
Answer: 39 cabbage army worm
```

### classification.20 `plantvillage-train-023416`

- Source: `plantvillage`
- Verifier: `label`
- Images: `data/raw/plantvillage/full/images/train/023416.png`
