...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--eval-config", default="configs/eval/agmmu.yaml")
...
def main() -> int:
    ...
    metrics = run_agmmu_eval(model_config=model_config, eval_config=eval_config)
