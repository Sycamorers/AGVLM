...
from agri_vlm.evaluation.agrobench_eval import run_agrobench_eval
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--eval-config", default="configs/eval/agrobench.yaml")
...
def main() -> int:
    ...
    metrics = run_agrobench_eval(model_config=model_config, eval_config=eval_config)
