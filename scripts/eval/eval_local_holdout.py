...
from agri_vlm.evaluation.local_eval import run_local_eval
...
def main() -> int:
    ...
    metrics = run_local_eval(model_config=model_config, eval_config=eval_config)
