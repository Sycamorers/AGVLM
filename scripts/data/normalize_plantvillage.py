#!/usr/bin/env python3
"""Normalize PlantVillage into the unified JSONL schema."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="data/interim/plantvillage.jsonl")
...
def main() -> int:
    ...
    rows = normalize_classification_directory_dataset(
        ...
        salt="plantvillage-v1",
    )
    write_manifest(repo_root / args.output, rows)
    print("normalized plantvillage rows=%s" % len(rows))
    return 0
