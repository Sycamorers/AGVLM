#!/usr/bin/env python3
"""Normalize AgBase-style consultation data into the unified JSONL schema."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-dir", default="data/raw/agbase")
    parser.add_argument("--output", default="data/interim/agbase.jsonl")
